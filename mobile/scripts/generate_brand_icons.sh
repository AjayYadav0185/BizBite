...
# =============================================================================
# A density-aware logo bitmap + the two launch_background.xml variants that the
# LaunchTheme windowBackground points at (values/ and values-night/ styles.xml).
...
# Light + dark variants each get their own backdrop colour so the badge never
# floats on a mismatched window (values-night/styles.xml uses Theme.Black).
cat > "$ANDROID/drawable/launch_background.xml" <<'XML'
<?xml version="1.0" encoding="utf-8"?>
<!-- BizBite launch screen (API < 21). Generated by
     mobile/scripts/generate_brand_icons.sh — do not hand-edit. -->
...
XML
cat > "$ANDROID/drawable-v21/launch_background.xml" <<'XML'
<?xml version="1.0" encoding="utf-8"?>
<!-- BizBite launch screen (API 21+). Generated by
     mobile/scripts/generate_brand_icons.sh — do not hand-edit. -->
<layer-list xmlns:android="http://schemas.android.com/apk/res/android">
...
cat > "$ANDROID/drawable-night/launch_background.xml" <<'XML'
<?xml version="1.0" encoding="utf-8"?>
<!-- BizBite launch screen, night mode. Generated by
     mobile/scripts/generate_brand_icons.sh — do not hand-edit. -->
<layer-list xmlns:android="http://schemas.android.com/apk/res/android">
    <item android:drawable="#0B0713" />
    <item>
        <bitmap
            android:gravity="center"
            android:src="@drawable/launch_logo" />
...
XML
echo "android: launch_background (drawable, drawable-v21, drawable-night) + launch_logo"
# =============================================================================
